    ...
    fun testAllNonNull() {
        withH2DB { db ->
            db.withTransaction {
                ...
                select("SELECT c_string, c_boolean, c_byte, c_short, c_int, c_long, c_float, c_double, c_bigdecimal, c_bytes, c_date, c_time, c_timestamp, c_ascii, c_char, c_binary, c_object, c_array FROM test_getters_all WHERE id = 1") {
                    readRecords {
